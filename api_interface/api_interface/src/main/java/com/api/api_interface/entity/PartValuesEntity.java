...
//public class User
{
    ...
    @Column(name = "part_weight", nullable = false)
    private Float part_weight;

    // quality reason graph calculation adding naveen 
    @Column(name = "material_price")
    private  Float material_price;

    // @Column(name = "part_weight")
    // private Integer part_weight;
    ...
    public PartValuesEntity(String part_id, String part_name, Integer nict, String tool_id, Float part_price, Float part_weight){
        this.part_id = part_id;
        this.part_name=part_name;
        this.nict=nict;
        this.tool_id=tool_id;
